  ...
  return (
    <section className="contact">
      ...
      <div className="container support">
        ...
        <form action="" method="get" className=" flex fex_direction center contact_form">
          <div className="flex center m-y-4 row">
            <input type="text" name="fname" className="m-x-4 input" placeholder="First Name" required/>
            <input type="text" name="lname" className="m-x-4 input" placeholder="Last Name" required/>
          </div>
          <div className="flex center m-y-4 row">
            <input type="email" name="email" className="m-x-4 input" placeholder="Email" required/>
            <input type="text" name="phone" className="m-x-4 input" placeholder="Phone Number" required/>
          </div>
          <div className="flex center m-y-4 row">
